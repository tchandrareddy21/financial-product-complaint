...
from finance.constants.prediction_pipeline_constants.file_config import ARCHIVE_DIR, INPUT_DIR, FAILED_DIR, \
...
ModelTrainerConfig = namedtuple("ModelTrainerConfig", ["base_accuracy",
