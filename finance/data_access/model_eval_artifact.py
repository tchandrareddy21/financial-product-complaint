from finance.config.mongo_client import MongodbClient
from finance.entity.artifact_entity import ModelEvaluationArtifact
...
class ModelEvaluationArtifactData:
    ...
    def __init__(self):
        ...
        self.collection_name = "model-evaluation-artifacts"
